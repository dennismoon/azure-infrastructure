...
$templateBasePath = "C:\srcARM\Azure-Infrastructure\AppInsights\"
$templateFilePath = $templateBasePath + "azuredeployAppInsights_v1_0_0.json"
$parametersFilePath = $templateBasePath + "azuredeployAppInsights_v1_0_0.parameters.json"
