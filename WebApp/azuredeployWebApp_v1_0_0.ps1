...
$templateBasePath = "C:\srcARM\Azure-Infrastructure\WebApp\"
$templateFilePath = $templateBasePath + "azuredeployWebApp_v1_0_0.json"
$parametersFilePath = $templateBasePath + "azuredeployWebApp_v1_0_0.parameters.json"
