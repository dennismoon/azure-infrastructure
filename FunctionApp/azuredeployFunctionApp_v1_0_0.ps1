...
$templateBasePath = "C:\srcARM\Azure-Infrastructure\FunctionApp\"
$templateFilePath = $templateBasePath + "azuredeployFunctionApp_v1_0_0.json"
$parametersFilePath = $templateBasePath + "azuredeployFunctionApp_v1_0_0.parameters.json"
